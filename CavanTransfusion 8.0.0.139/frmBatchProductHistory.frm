...
Begin VB.Form frmBatchProductHistory 
   ...
   ClientTop       =   555
   ClientWidth     =   14700
   Icon            =   "frmBatchProductHistory.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8685
   ...
   Begin VB.CommandButton cmdPrintLabel 
      ...
      Height          =   1005
      Left            =   3810
      Picture         =   "frmBatchProductHistory.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   11
      Tag             =   "bprintlabels"
      Top             =   7350
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   1005
      Left            =   13680
      Picture         =   "frmBatchProductHistory.frx":0BD4
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   7350
      Width           =   900
   ...
   Begin VB.CommandButton cmdXL 
      ...
      Height          =   1005
      Left            =   6180
      Picture         =   "frmBatchProductHistory.frx":1A9E
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   7350
      Width           =   900
   ...
   Begin VB.CommandButton cmdSearch 
      ...
      Height          =   810
      Left            =   2670
      Picture         =   "frmBatchProductHistory.frx":76B0
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   150
      Width           =   900
   ...
   Begin VB.CommandButton bPrintBoth 
      ...
      Height          =   1005
      Left            =   2850
      Picture         =   "frmBatchProductHistory.frx":7B3B
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   7350
      Width           =   900
   ...
   Begin VB.CommandButton bPrint 
      ...
      Height          =   1005
      Left            =   120
      Picture         =   "frmBatchProductHistory.frx":7E45
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   7350
      Width           =   900
   ...
   Begin VB.CommandButton bPrintSpecific 
      ...
      Height          =   1005
      Left            =   1890
      Picture         =   "frmBatchProductHistory.frx":84AF
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   7350
      Width           =   900
   ...
   Begin MSFlexGridLib.MSFlexGrid g 
      ...
      GridLinesFixed  =   3
      AllowUserResizing=   1
      FormatString    =   $"frmBatchProductHistory.frx":8B19
   End
   ...
   Begin VB.Label Label8 
      ...
      Caption         =   "Select Identifier to show History"
      ForeColor       =   &H80000018&
      Height          =   255
      Left            =   60
      TabIndex        =   23
   ...
   End
End
Attribute VB_Name = "frmBatchProductHistory"
...
50    If Trim$(txtBatchNumber) = "" Then Exit Sub

60    BPs.LoadSpecificBatch txtBatchNumber

70    If BPs.Count = 0 Then
80      iMsg "Batch Number not found!", vbExclamation
...
140     s = BP.Identifier & vbTab & _
            BP.SampleID & vbTab & _
            gEVENTCODES(BP.EventCode).Text & vbTab & _
            Format(BP.RecordDateTime, "dd/mm/yy hh:nn:ss") & vbTab & _
            BP.PatName & vbTab & _
            BP.Chart & vbTab & _
            BP.Addr0 & vbTab
...
310   LogError "frmBatchProductHistory", "FillG", intEL, strES
...
60      lblCurrentStock = BPs.CountProductBatchInStock(BP.Product, txtBatchNumber)
...
130   LogError "frmBatchProductHistory", "FillCommonDetails", intEL, strES
...
100   Printer.Print txtBatchNumber
...
450   LogError "frmBatchProductHistory", "bprint_Click", intEL, strES
...
370   LogError "frmBatchProductHistory", "bPrintBoth_Click", intEL, strES, sql
...
190   LogError "frmBatchProductHistory", "cmdPrintLabel_Click", intEL, strES
...
360   LogError "frmBatchProductHistory", "bPrintSpecific_Click", intEL, strES, sql
...
260   With frmBatchProductIdentifierHistory
270     .Identifier = g.TextMatrix(g.row, 0)
280     .BatchNumber = txtBatchNumber
290     .Show 1
300   End With
...
340   LogError "frmBatchProductHistory", "g_Click", intEL, strES
