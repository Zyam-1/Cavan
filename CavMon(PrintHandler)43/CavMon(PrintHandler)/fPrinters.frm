...
100     MsgBox "Make a selection from the available printers.", vbInformation
110   End If
...
210   LogError "fPrinters", "bSave_Click", intEL, strES, sql
...
10    If bSave.Enabled Then
20      If MsgBox("Cancel without saving?", vbQuestion + vbYesNo) = vbNo Then
30        Cancel = True
40      End If
50    End If
...
50    If Trim$(NewName) = "" Then
60      Exit Sub
70    End If

'80    If MsgBox("Change " & vbCrLf & OldName & vbCrLf & "to" & vbCrLf & NewName, vbQuestion + vbYesNo) = vbNo Then Exit Sub

80    g.TextMatrix(g.Row, 1) = NewName
