...
10    On Error GoTo CheckDisciplineActive_Error

20    sql = "Select Distinct LongName, SampleType, Category, Hospital " & _
...
60      sql = "Update " & Discipline & "TestDefinitions " & _
              "Set ActiveToDate = '" & Format$(Now, "dd/mmm/yyyy") & "' where " & _
...
110   intEL = Erl
120   strES = Err.Description
130   LogError "modDefinitionsActive", "CheckDisciplineActive", intEL, strES, sql
