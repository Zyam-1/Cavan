...
Begin VB.Form frmLukesPhenotype 
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Height          =   765
      Left            =   4050
      Picture         =   "frmLukesPhonotype.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   3660
      Width           =   1155
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   765
      Left            =   5580
      Picture         =   "frmLukesPhonotype.frx":066A
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   3660
      Width           =   1155
   ...
   Begin VB.CommandButton cmdLoad 
      ...
      Height          =   765
      Left            =   2490
      Picture         =   "frmLukesPhonotype.frx":0CD4
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   3660
      Width           =   1155
   ...
   Begin MSFlexGridLib.MSFlexGrid grdLotNos 
      ...
      GridLinesFixed  =   3
      ScrollBars      =   0
      FormatString    =   $"frmLukesPhonotype.frx":133E
...
90    If HospName(0) = "Cavan" Then
100     cmdLoad.Enabled = True
110     grdLotNos.RowHeight(2) = 0
120   Else
130     cmdLoad.Enabled = False
140   End If
150   Exit Sub
...
180   LogError "frmLukesPhenotype", "Form_Load", intEL, strES, sql
End Sub
