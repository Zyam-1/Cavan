...
31740     If mPass Then
31750         txtInput.PasswordChar = "*"
31760     Else
31770         txtInput.PasswordChar = ""
31780     End If

31790     txtInput.SelStart = 0
31800     txtInput.SelLength = Len(txtInput)
31810     txtInput.SetFocus

End Sub

Public Property Let Password(ByVal blnNewValue As Boolean)

31820     mPass = blnNewValue
